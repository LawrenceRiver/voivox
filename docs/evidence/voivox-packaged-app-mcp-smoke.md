...
- Chrome bridge origin: the single packaged VOIVOX extension ID

## Artifact checks

| Artifact | Size | SHA-256 |
| --- | ---: | --- |
| `VOIVOX-0.1.0-arm64.dmg` | 112 MB | `b4fde497e575c6d1a4b16bd6a4b251582f7a72772691734f844d63bd42cf3e10` |
| `VOIVOX-0.1.0-arm64.zip` | 113 MB | `2f925a462bec1fc132d78900f025bf767aebce935690fdd7a3ee1c2abf864b6c` |
| `VOIVOX-Chrome-Extension-0.1.0.zip` | 5.2 MB | `3fe200876667f0c4e22e5c99659c5d1ff5b3b1bcbded231d4b29ac5509e13c66` |
...
1. Launched `VOIVOX.app` from the rebuilt arm64 bundle.
